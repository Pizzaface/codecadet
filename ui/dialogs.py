...
from PySide6.QtWidgets import (
    ...
    QListWidget, QListWidgetItem, QCheckBox, QComboBox, QFrame
)
...
class AgentConfigDialog(QDialog):
    ...
    def __init__(self, parent, config: dict):
        ...
        from config import (get_coding_agents, get_default_agent, set_agent_config, 
                          remove_agent_config, set_default_agent)
